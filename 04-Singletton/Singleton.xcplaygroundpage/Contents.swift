...
// let app2 = UIApplication() // Not allowed because only one instance of UIApplication is allowed

public class MySingleton {
    static let shared = MySingleton()
    
    // init is private to prevent the creation of additional instances
    private init() { }
}
