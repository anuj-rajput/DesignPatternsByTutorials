...
extension PetViewModel {
    /// method to configure the view using the view model instead of doing things inline
...
/// Configure the subviews of `view` using `viewModel`
viewModel.configure(view)

/// set the view to `PlaygroundPage.current.liveView` which tells the playground to render it within the standard *Assistant editor*
