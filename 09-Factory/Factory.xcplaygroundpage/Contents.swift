...
public struct Email {
    ...
    public let recepientEmail: String
...
public struct EmailFactory {
    ...
    public func createEmail(to recepient: JobApplicant) -> Email {
        ...
        case .interview:
            ...
            messageBody = "Thanks for your resume, \(recepient.name)! " + "Cam you come in for an interview in 30 minutes?"
            
        case .hired:
            subject = "We Want to Hire You"
            messageBody = "Congratulations, \(recepient.name)! " + "We liked your code, and you smelled nice. " + "We want to offer you a position! Cha-ching! $$$"
            
        case .rejected:
            subject = "Thanks for Your Application"
            messageBody = "Thank you for applying, \(recepient.name)! " + "We have decided to move forward with other candidates." + "Please remember to wear pants next time!"
        }
        
        return Email(subject: subject, messageBody: messageBody, recepientEmail: recepient.email, senderEmail: senderEmail)
    }
}
